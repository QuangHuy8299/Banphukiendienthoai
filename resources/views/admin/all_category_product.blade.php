        ...
        <tbody>
          ...
          <tr>
            ...
            <td><span class="text-ellipsis">
              ...
              ?>
                <a href='{{ URL::to('/unactive-category-product/'.$cate_pro->category_id) }}'><span class='btn btn-danger'>Hiển thị</span></a>" 
              <?php
              }else{
              ?>
              <a href='{{ URL::to('/active-category-product/'.$cate_pro->category_id) }}'><span class='btn btn-primary'>Hiển thị</span></a>
              <?php  
            }
              ?>
            </span></td>
